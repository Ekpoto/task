<footer>
        <div class="footer">
            <div class="container">
                ...
                <div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
                    <h3>CONTACT INFO</h3>
                    <ul>
                        <li><i class="fa fa-home fa-2x"></i> Office # 3, James Igbe Close, olodi Apapa Lagos, zip 40112</li><hr>
                        <li><i class="fa fa-phone fa-2x"></i> 08160894221</li><hr>
                        <li><i class="fa fa-envelope fa-2x"></i> idomatthew@gmail.com</li>
                    </ul>
                </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        &copy; 2015 <a target="_blank" href="http://bootstraptaste.com/" title="Free Twitter Bootstrap WordPress Themes and HTML templates">Amatech</a>. All Rights Reserved.
                    </div>
                    <!--
